...
const coderBoxVueLoader: LoaderFunctionType = async function (value, config) {
  ...
  const scriptStr = transform(script?.content || scriptForTab || 'export default {}', {
    presets: ['es2015']
  }).code
...
export default coderBoxVueLoader
