import { DefaultConfigType } from '@renderer/types/coderBox'
import MinicoderBox from './index'
...
export function generateMenuOptions(this: MinicoderBox): OptionsType {
    ...
    },
    {
      ...
      children: [
        ...
        { type: 'hr' },
        {
          type: 'li',
          text: '官方文档',
          callback: () => window.open('https://buuing.github.io/mini-coderBox')
        },
        {
          type: 'li',
          text: 'Github 仓库',
          callback: () => window.open('https://github.com/buuing/mini-coderBox')
        },
        {
          type: 'li',
          text: 'Bug 反馈',
          callback: () => window.open('https://github.com/buuing/mini-coderBox/issues')
        },
        { type: 'hr' },
        {
          type: 'li',
          text: '📋 开源协议 MIT License',
          callback: () => window.open('https://github.com/buuing/mini-coderBox/blob/master/LICENSE')
        }
      ]
    }
  ]
